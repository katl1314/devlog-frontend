...
export default function AuthForm() {
	const googleButtonCSS = 'bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50';
	const githubButtonCSS =
		'bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 transition ease-in duration-200 shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2';
