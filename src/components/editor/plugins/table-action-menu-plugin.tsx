...
function TableActionMenu({
	...
	if (cellMerge) {
		if (canMergeCells) {
			mergeCellButton = <CommandItem onSelect={() => mergeTableCellsAtSelection()}>Merge cells</CommandItem>;
		} else if (canUnmergeCell) {
			mergeCellButton = <CommandItem onSelect={() => unmergeTableCellsAtSelection()}>Unmerge cells</CommandItem>;
		}
	}
			...
			<Command>
				<CommandList>
					<CommandGroup>
						...
						<CommandItem onSelect={() => toggleRowStriping()}>Toggle row striping</CommandItem>
						<CommandSeparator />
						...
						<CommandSeparator />
						<CommandItem onSelect={() => deleteTableColumnAtSelection()}>Delete column</CommandItem>
						<CommandItem onSelect={() => deleteTableRowAtSelection()}>Delete row</CommandItem>
						<CommandItem onSelect={() => deleteTableAtSelection()}>Delete table</CommandItem>
						<CommandSeparator />
...
function TableCellActionMenuContainer({
	...
	return (
		<div className="table-cell-action-button-container absolute top-0 will-change-transform" ref={menuButtonRef}>
			{tableCellNode != null && (
