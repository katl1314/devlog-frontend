...
export default function SidebarWidgets() {
	...
	return (
		<div className="sticky top-0 flex flex-col gap-5 py-6 px-5 h-screen overflow-y-auto">
			{/* 검색 */}
			<div
				className={`flex items-center gap-3 bg-muted rounded-full px-4 py-3 border transition-all ${
					query ? 'border-blue-500 ring-2 ring-blue-500/10 bg-card' : 'border-transparent'
				}`}
			>
