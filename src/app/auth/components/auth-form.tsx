		...
		<div className="min-h-screen flex">
			<div className="hidden md:flex md:w-105 lg:w-120 shrink-0 bg-zinc-950 flex-col justify-between p-10 lg:p-14">
				<div className="flex items-center gap-2.5">
					...
					<span className="text-white font-semibold text-xl tracking-tight">Dev.log</span>
				</div>
			...
			<div className="md:flex-1 md:flex md:flex-col md:items-center md:justify-center md:py-14 px-6 py-25 bg-background">
				<div className="md:hidden flex items-center gap-2 mb-10">
					...
					<span className="font-semibold text-xl text-foreground tracking-tight">Dev.log</span>
				</div>
				...
				<div className="w-full max-w-85">
					...
					<button
						...
						className="w-full flex items-center justify-center gap-2.5 border border-border rounded-md py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors disabled:opacity-50 cursor-pointer"
					>
					...
					<div className="relative my-5">
						...
						<div className="relative flex justify-center text-xs">
							<span className="bg-background px-2.5 text-muted-foreground">또는</span>
						</div>
					</div>
					...
					{mode === 'social' && (
						<button
							...
							className="w-full flex items-center justify-center border border-border rounded-md py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors cursor-pointer"
						>
							이메일로 계속하기
						</button>
					)}
					...
					{mode === 'email' && (
						<form onSubmit={handleEmailSubmit} className="space-y-3.5">
							...
							<button
								...
								className="w-full text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer pt-1 text-center"
							>
								← 다른 방법으로 로그인
							</button>
						</form>
