			...
			<main className="w-full max-w-md z-10">
				...
				<div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-100/50 border border-white p-8 md:p-12 transition-all hover:shadow-indigo-200/40">
					...
					<div className="text-center mb-10">
						...
						<h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Dev.log</h1>
				...
				<div className="mt-8 text-center space-y-1">
					...
					<p className="text-slate-400 text-xs">
						<span className="text-slate-500 font-medium cursor-pointer hover:underline">개인정보처리방침</span>에 동의하게 됩니다.
					</p>
				</div>
			</main>
		</div>
